...
Route::get('/post', [Post_Controller::class, 'show'])->middleware('auth');
...
Route::post('/user/comment', [Post_Controller::class, 'comment'])->middleware('auth');

Route::post('/post/{postId}/comment', [Post_Controller::class, 'comment'])->name('post.comment');
...
Route::put('/profile/user/edit', [User_Controller::class, 'update'])->middleware('auth');
