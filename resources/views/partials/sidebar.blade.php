<nav id="sidebar" class="sidebar js-sidebar">
    <div class="sidebar-content js-simplebar">
        <a class="sidebar-brand text-center" href="/home">
            <span class="align-middle">Unisan Gorut</span>
        </a>
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item {{ $title === 'Buat Tulisan' ? 'active' : '' }}">
                <a class="sidebar-link" href="/user/create/post">
                    <i class="bi bi-pencil fs-5 align-middle"></i><span class="align-middle">Buat Tulisan</span>
                </a>
            </li>
